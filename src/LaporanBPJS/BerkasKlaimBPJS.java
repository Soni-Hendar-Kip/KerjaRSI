 ...
 * @author montox
 */
public class BerkasKlaimBPJS extends javax.swing.JFrame {

    /**
     * Creates new form BerkasKlaimBPJS
     */
    public BerkasKlaimBPJS() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BerkasKlaimBPJS.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new BerkasKlaimBPJS().setVisible(true);
            }
        });
    }
